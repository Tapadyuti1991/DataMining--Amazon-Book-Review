...
<head>
	...
	<script type="text/javascript" src="resources/js/libs/jquery-1.6.2.min.js"></script>
	<script type="text/javascript" src="resources/js/libs/jquery.jcarousel.min.js"></script>
	<!--[if IE 6]>
...
<body>
	...
	<div id="header" class="shell">
		<div id="logo"><h1><a href="#">BestSeller</a></h1><span><a href="dictionary">Complete Dashboard for Publishers</a></span></div>
		<!-- Navigation -->
		<div id="navigation">
			<ul>
                            <li style="Strong"><a href="#" class="active">Home</a></li>
				<li><a href="metrics">Metrics</a></li>
				<li><a href="flot">Follow Other Readers</a></li>
				<li><a href="#">Mahout Recommendations</a></li>
				<li><a href="#">Best Review Practices</a></li>
                                <li><a href="#">Incentivized Reviews</a></li>
			</ul>
		</div>
		<!-- End Navigation -->
		<div class="cl">&nbsp;</div>
			...
			<ul>
				<li>
					...
					<div class="details">
						...
						<p class="description">Featured Products are the top 8 books on the basis of ratings</p>
						<p class="description">Bestsellers are the top 8 books on the basis of each years bestsellers</p>
                                                <p class="description">This page is showing the results constructed using MongoDB</p>
					</div>
				</li>
<!--				<li>
					<div class="image">
				...
				<ul>
					...
					<li>
						<div class="product">
							...
							<a href="#" class="buy-btn">Read Reviews<span class="price"><span class="low">+</span><span class="high"></span></span></a>
						</div>
					</li>
					<li>
						<div class="product">
					...
					<li>
						<div class="product">
							<a href="#">
								...
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
								<span class="price"><span class="low"></span>5.0<span class="high"></span></span>
							</a>
						</div>
					</li>
				</ul>
